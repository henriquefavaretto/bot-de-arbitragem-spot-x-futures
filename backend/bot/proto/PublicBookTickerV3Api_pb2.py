...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PUBLICBOOKTICKERV3API']._serialized_start=37
  _globals['_PUBLICBOOKTICKERV3API']._serialized_end=138
